...
```shell
#版本号去git上查看
wget https://imageyu.oss-cn-beijing.aliyuncs.com/dont-stop-agent-1.1.jar
java -Xbootclasspath/a:$JAVA_HOME/lib/tools.jar -jar dont-stop-agent-1.1.jar
```
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201103181215644.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0RheV9EYXlfTm9fQnVn,size_16,color_FFFFFF,t_70#pic_center)
